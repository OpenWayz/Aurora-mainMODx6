langs.enUS = {
  ...
  '大陆首选 亚洲区最佳 工具': 'Mainland first choice Best tool in Asia',
  '打开 Telegram 搜索': 'Open Telegram Search',
  '立即尝试多协议 代理 服务': 'Try multi-protocol proxy service immediately',
  '银行户口、电邮密码、个人资料': 'Bank accounts, email passwords, personal information',
  '什么是 网络代理 ？它有何帮助？': 'What is a Proxy? How can it help?',
  ...
  '你们的 网络代理 能在哪些设备上运作？': 'On which devices can your Proxy operate?',
  ...
  '为什么你们的私有 代理 协议能做到稳定高速？': 'Why can your proprietary Proxy protocol achieve stable high speed?',
  ...
  '最先进流量隐藏技术，将穿墙流量化身网页浏览，免于防火墙干扰。':
    'The most advanced traffic hiding technology disguises  wall-piercing traffic as web browsing to avoid firewall interference.',
  '私密浏览？浏览器无痕模式不够。我们的Proxy为您隐藏IP以掩藏踪迹。':
    'Private browsing? Incognito mode in browsers is not enough. Our Proxy hides your IP to cover your tracks.',
  ...
  '在防火墙检查时，混淆后的 Proxy 流量看似普通网上冲浪或电影串流。因此，审查者无法确定哪些流量需要阻止，哪些流量可以放行。':
    'When the firewall checks, the obfuscated Proxy traffic looks like normal online surfing or movie streaming. Therefore, censors cannot determine which traffic needs to be blocked and which traffic can pass.',
  ...
  '我们自研的私有协议，可以模拟多种网页浏览场景。使得防火墙无法可靠区分 Proxy 数据浏览。如强行阻拦亦会影响正常使用网络，因此连接无法有效拦截。':
    'Our proprietary protocol can simulate a variety of web browsing scenarios, making it impossible for firewalls to reliably distinguish between Proxy data browsing. Forced blocking will also affect normal network use, so the connection cannot be effectively intercepted.',
  'Proxy 提供了一系列好处：通过加密，通讯数据变得难以破解；藉由隧道，线上活动的细节内容被掩藏；借助转发，网路流量看似来自无关的 IP 地址和地理位置。':
    'Proxy provides a series of benefits: through encryption, communication data becomes difficult to crack; through tunnels, the details of online activities are hidden; with the help of forwarding, network traffic appears to come from unrelated IP addresses and locations.',
  ...
  '市面上几乎所有的电子设备，我们都能支持。鉴于我们支援多种开源和自研的 Proxy 协议，我们相信您可以在几乎任何市售设备上轻松连接到我们的 Proxy 网络。':
    'We can support almost all electronic devices on the market. Given that we support a variety of open source and proprietary Proxy protocols, we believe you can easily connect to our Proxy network on almost any commercially available device.',
  'Proxy 是虚拟专用网络（Virtual Private Network）的缩写。它通过在公共网络上建立专用隧道并加密其中传输的数据来保护两个或多个设备之间的通信。':
    'Proxy is the abbreviation of Virtual Private Network. It establishes private tunnels over public networks and encrypts data transmission to protect communication between two or more devices.',
  ...
  '交通混淆和质押自由是有效规避互联网封锁的基石。混淆将 Proxy 流量伪装成常规的 Web 浏览，审查者无从分辨；质押自由意味着，由于误封的成本过高，审查机构不会阻止无法明确分辨的流量。':
    'Traffic obfuscation and bail freedom are the cornerstones of effectively circumventing Internet censorship. Obfuscation disguises Proxy traffic as normal web browsing, leaving censors indistinguishable; bail freedom means that due to the high cost of false blocking, censorship agencies will not block traffic that cannot be clearly distinguished.',
