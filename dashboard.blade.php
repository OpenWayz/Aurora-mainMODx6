  ...
  <body>
    ...
    <script>
      ...
      function isDarkMode() {
        ...
        var isDark = false
        var localMode = JSON.parse(localStorage.getItem('__MURUA__Darkmode') || '{}').value
      ...
      function getLocaleLang() {
        try {
          var str = localStorage.getItem('__MURUA__Language') || '{}'
